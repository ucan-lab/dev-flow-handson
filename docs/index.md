...
1. **Claude Skills によるローカル作業の自動化** — コミット・コミット整理・PR 作成・レビュー対応
2. **Gemini Code Assist による無料の PR 自動レビュー**
3. **GitHub Actions によるリリース自動化** — リリース PR 作成 / リリースノート生成
...
1. `/git-commit` `/git-commit-organizer` `/pr-create` スキルで **PR 提出までを 1 コマンド化** できる
